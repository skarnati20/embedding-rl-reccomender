...
def main():
    parser = argparse.ArgumentParser(description='Process text files into CSV with embeddings')
    parser.add_argument('--input_dir', type=str, required=True, help='Path to the directory containing text files')
